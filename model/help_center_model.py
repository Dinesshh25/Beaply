...
def kirim_feedback(id_user, kategori, pesan):
    ...
    if not kategori or kategori not in ["Bug Report", "Suggestion", "Question", "Other","bug", "saran", "pertanyaan"]:
        print("  [ERROR] Kategori harus: Bug Report, Suggestion, Question, Other.")
        return False
