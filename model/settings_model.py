...
from utils.helpers import validasi_edit_profil, parse_int_or_none, parse_float_or_none
...
def ubah_tema(tema: str) -> tuple[bool, str]:
    if tema not in ("light", "dark", "system"):
        return False, "Tema harus 'light', 'dark', atau 'system'."
    return True, tema
...
from model.database import ganti_password_db, ambil_profil_db

def ganti_password(id_profil: int, new_pass: str) -> tuple[bool, str]:
