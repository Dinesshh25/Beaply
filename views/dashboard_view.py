...
from model.settings_model import ambil_preferensi
...
from views.profile_view import HalamanProfil
from views.settings_view import HalamanSettings
from views.help_center_view import HalamanHelpCenter
...
class HalamanDashboardUtama(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        bookmark_count = len(ambil_bookmark(self.profil_id))
