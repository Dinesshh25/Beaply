"""
views/components/i18n.py
Beaply - Internationalization (i18n)

Terjemahan teks (ID/EN).
Dipecah dari: ui_utils.py (bagian TEKS dict)
"""
...
TEKS = {
    "id": {
        ...
        "menu_scholarships":"Eksplorasi",
        "menu_recom":       "Rekomendasi",
        "menu_bookmarks":   "Tersimpan",
        ...
        "title_scholarships":"Eksplorasi Beasiswa",
        "title_recom":      "Rekomendasi Beasiswa",
        "title_bookmarks":  "Beasiswa Tersimpan",
        "title_calendar":   "Kalender Deadline",
        "title_notif":      "Notifikasi",
        "title_profile":    "Profil Mahasiswa",
        "title_help":       "FAQ & Pusat Bantuan",
        ...
        # ── Tambahan untuk Halaman Auth ──
        "login_subjudul":   "Silakan masuk ke akun Anda",
        "field_password":   "Kata Sandi",
        "login_lupa_sandi": "Lupa Kata Sandi?",
        "btn_masuk":        "Masuk",
        "login_blm_punya":  "Belum punya akun?",
        "btn_daftar":       "Daftar Sekarang",
        "reg_judul":        "Daftar Akun Baru",
        "reg_subjudul":     "Lengkapi data Anda untuk mendaftar",
        "field_nama":       "Nama Lengkap",
        "field_konfirmasi_pass": "Konfirmasi Kata Sandi",
        "btn_daftar_sekarang": "Daftar Akun",
        "reg_sdh_punya":    "Sudah punya akun?",
        # ── Sidebar ──
    ...
    "en": {
        ...
        "title_dashboard":  "Dashboard",
        "title_scholarships":"Explore Scholarships",
        "title_recom":      "Recommendations",
        "title_bookmarks":  "Saved Scholarships",
        "title_calendar":   "Deadline Calendar",
        "title_notif":      "Notifications",
        "title_profile":    "Student Profile",
        "title_help":       "FAQ & Help Center",
        ...
        # ── Tambahan untuk Halaman Auth ──
        "login_subjudul":   "Please login to your account",
        "field_password":   "Password",
        "login_lupa_sandi": "Forgot Password?",
        "btn_masuk":        "Login",
        "login_blm_punya":  "Don't have an account?",
        "btn_daftar":       "Register Now",
        "reg_judul":        "Register New Account",
        "reg_subjudul":     "Complete your data to register",
        "field_nama":       "Full Name",
        "field_konfirmasi_pass": "Confirm Password",
        "btn_daftar_sekarang": "Register Account",
        "reg_sdh_punya":    "Already have an account?",
        # ── Sidebar ──
        "nav_dashboard":    "🏠 Dashboard",
